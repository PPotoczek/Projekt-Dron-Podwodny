...
int main()
{
    /*
     *
     * NIE MA JESZCZE POPRAWIONEGO MAKEFILE , WYKRYWANIE KOLIZJI NIE DZIALA
     *
     */
    std::shared_ptr<drawNS::Draw3DAPI> api(new drawNS::APIGnuPlot3D(-10,10,-10,20,-10,10,-1));
    Powierzchnia Powi(api);
    std::shared_ptr<Przeszkoda_Prostopadloscian> Przeszkoda1;
    Przeszkoda1 = static_cast<std::shared_ptr<Przeszkoda_Prostopadloscian>>(new Przeszkoda_Prostopadloscian(api,Wektor<double,3>(8,15,-5),4,4,10));
    //Przeszkoda_Prostopadloscian Przeszkoda1(api,Wektor<double,3>(8,15,-5),4,4,10);
    std::shared_ptr<Przeszkoda_Prostopadloscian> Przeszkoda2;
    Przeszkoda1 = static_cast<std::shared_ptr<Przeszkoda_Prostopadloscian>>(new Przeszkoda_Prostopadloscian(api,Wektor<double,3>(-3,8,5),10,2,8));
    //Przeszkoda_Prostopadloscian Przeszkoda2(api,Wektor<double,3>(-3,8,5),10,2,8);
    std::shared_ptr<Przeszkoda_Prostopadloscian> Przeszkoda3;
    Przeszkoda1 = static_cast<std::shared_ptr<Przeszkoda_Prostopadloscian>>(new Przeszkoda_Prostopadloscian(api,Wektor<double,3>(3,9,-5),5,7,3));
    //Przeszkoda_Prostopadloscian Przeszkoda3(api,Wektor<double,3>(3,9,-5),5,7,3);
    std::shared_ptr<Przeszkoda_Prostopadloscian> Przeszkoda4;
    Przeszkoda1 = static_cast<std::shared_ptr<Przeszkoda_Prostopadloscian>>(new Przeszkoda_Prostopadloscian(api,Wektor<double,3>(-7,5,-3),-5,8,8));
    //Przeszkoda_Prostopadloscian Przeszkoda4(api,Wektor<double,3>(-7,5,-7),-5,8,8);
    ...
    double kat;
    double odleglosc;
    Dron D(api,Wektor<double,3>(0,0,0));
    Dron Przyklad1(api,Wektor<double,3>(5,5,5));
    Dron Przyklad2(api,Wektor<double,3>(3,-3,-3));
    for (;;)
    {
        cout << "==MENU==" << endl;
        ...
        switch (wybor)
        {
            case 'w':  //przod
            {
                ...
                D.Przod(odleglosc, kolekcja_przeszkod);
                break;
            }
            /*
            case 's': // tyl
