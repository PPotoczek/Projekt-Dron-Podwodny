...
protected:
     ...
     */
    Prostopadloscian D;
    Wektor<double, 3> Pozycja1;
    Wektor<double, 3> Pozycja2;
    Wirnik P;
    Wirnik L;
public:
    /*!
    ...
    /*!
     * Metoda sprawdzajaca kolizje drona z przeszkoda
     * \param D Wskaznik na drona
     */
    bool Kolizja(Interfejs_Drona *D) {};
    /*!
     * Metoda zwracajaca srodek drona
     */
...
void Dron::Przod(double odleglosc)//, std::vector<std::shared_ptr<Przeszkoda> > &kolekcja_przeszkod)
{
    ...
    for(int i=0;i<100;i++)
    {
        ...
        {
            kolekcja_przeszkod[i]->Kolizja(<Interfejs_Drona *>(this));
        }
         */
        L.Czysc();
        P.Czysc();
